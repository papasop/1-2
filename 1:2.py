...
def direction_A_RH_implies_realizability():
    ...
    print()
    print("Summary — what each condition contributes:")
    print("  E^{1/2}_mean : distinguishes sigma (only sigma=0.5 satisfies it)")
    print("  R^{1/2}      : background — zero-cost direction exists")
    print("  T^{1/2}      : background — temporal cost positive (all sigma)")
    print("  ND           : background — light cone sharp (all sigma, Littlewood)")
    print("  The three background conditions establish causal structure.")
    print("  E^{1/2}_mean is the condition that selects sigma = 1/2.\n")
...
def why_sigma_is_forced():
    ...
    print("─" * 58)
    print("""
  Physical constitution of the prime universe — four conditions:

  Condition        Meaning                    Role
  ──────────────────────────────────────────────────────────────────
  R^{1/2}        Causal directions exist    Background (all sigma)
  T^{1/2}        Universe does not collapse Background (all sigma)
  ND             Light cone is sharp        Background (all sigma)
  E^{1/2}_mean   Amplitude scale = sqrt(x)  SELECTS sigma = 1/2
  ──────────────────────────────────────────────────────────────────

  Diagnostic (numerical):
    T^{1/2} and ND hold for ALL sigma — they do NOT distinguish sigma.
    R^{1/2} holds for sigma=0.5 (and borderline for sigma=0.6/0.7).
    E^{1/2}_mean is the condition that breaks for sigma > 1/2.

  Correct statement of the perspective shift:
    Requiring the prime universe to satisfy quantum realizability
...
""")
    ...
    print()
    print("  E^{1/2}_mean selects sigma=1/2; the three background conditions")
    print("  (R^{1/2}, T^{1/2}, ND) establish the causal framework.")
